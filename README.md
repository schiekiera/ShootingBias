# ShootingBias
Matlab Implementation of the shooter task  a famous socialpsychological behavioral test for measuring implicit racial bias (Correll et al., 2002)

# Table of Contents

- [ShootingBias](#shootingbias)
...
The shooter bias is used as a tool to study implicit biases and the influence of stereotypes on decision-making in potentially threatening situations. It sheds light on the potential influence of racial and ethnic biases on judgments and actions, highlighting the need for understanding and addressing these biases to promote fair and just outcomes.
